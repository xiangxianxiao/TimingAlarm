...
#import "MyCalendarManage.h"
#import "MyDateSecurity.h"

@interface MyCalendarManage ()
...
@implementation MyCalendarManage

+ (MyCalendarManage *)manage
{
    static MyCalendarManage * manageSinglenton = nil;
...
//    [dateFormatt setDateFormat:@"MM-dd"];
    ...
    switch (month) {
        case 5:
            weekBay = [comps weekday];
            if (dayInMonth == 14 - weekBay) {
                chineseCal_str = @"母亲节";
            }
            break;
        case 6:
            weekBay = [comps weekday];
            if (dayInMonth == 21 - (weekBay)) {
                chineseCal_str = @"父亲节";
            }
            break;
        case 11:
            weekBay = [comps weekday];
            if (dayInMonth == 26 - weekBay) {
                chineseCal_str = @"感恩节";
            }
            break;
